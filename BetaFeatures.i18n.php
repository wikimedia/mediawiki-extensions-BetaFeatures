...
$messages['ce'] = array(
	...
	'betafeatures-section-desc' => '{{PLURAL:$1|Йина керла фунуцеш}} оха уьш йина {{SITENAME}}н. Дехар до, {{PLURAL:$1|уьш}} лела яй а хьайна хетарг ала,тӀакха тхуна уьш дика ян аьтту хира бу.',
...
$messages['ru'] = array(
	...
	'betafeatures-section-desc' => '{{PLURAL:$1|Появилась новая функция, которую|Появилось несколько новых функций, которые}} мы продумываем для {{grammar:genitive|{{SITENAME}}}}. Пожалуйста, попробуйте {{PLURAL:$1|её|их}} и выскажите нам свои соображения, чтобы мы могли улучшить {{PLURAL:$1|это нововведения|эти нововведения}}, основываясь на ваших отзывах.',
...
$messages['uk'] = array(
	...
	'betafeatures-section-desc' => 'Тут  {{PLURAL:$1|є нова функція, яку|деякі нові функції, які}} ми розробляємо для  {{SITENAME}}. Спробуйте їх та висловіть ваші думки, щоб ми могли покращити їх, виходячи з ваших відгуків.',
