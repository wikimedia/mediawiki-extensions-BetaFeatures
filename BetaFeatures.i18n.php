...
$messages['ru'] = array(
	...
	'mw-ui-feature-info' => 'информация',
	'mw-ui-feature-user-count' => '{{PLURAL:$1|Один пользователь включил|$1 пользователей включили|0=Никто не включил|$1 пользователя включили}} эту функцию.', # Fuzzy
	'mw-ui-feature-requirements-betafeatures' => 'Эта функция требует, чтоб {{PLURAL:$1|1=была включена следующая функция|были включены следующие функции}}:', # Fuzzy
	'mw-ui-feature-requirements-browser' => '{{PLURAL:$1|1=Следующий браузер не поддерживается|Следующие браузеры не поддерживаются}}:', # Fuzzy
	'mw-ui-feature-requirements-javascript' => 'Эта функция требует JavaScript.',
	'mw-ui-feature-requirements-skins' => 'Эта функция работает только со {{PLURAL:$1|1=следующей темой|следующими темами}}:', # Fuzzy
